...
def generer_svg_couverture(params)
  ...
  "<svg xmlns='http://www.w3.org/2000/svg' shape-rendering='auto' viewBox='0 0 250 350' preserveAspectRatio='xMidYMid slice' data-coversize-target='svg'>#{svg_content}</svg>"
end
